...
#define PYMODULE_ADDSTRCONSTANT(name) PyModule_AddStringConstant(m, #name, (name))
    ...
    PYMODULE_ADDINTCONSTANT(LRO_SSLVERIFYSTATUS);
    ...
    PYMODULE_ADDINTCONSTANT(LRO_PROXY_SSLVERIFYPEER);
    PYMODULE_ADDINTCONSTANT(LRO_PROXY_SSLVERIFYHOST);
    PYMODULE_ADDINTCONSTANT(LRO_PROXY_SSLCLIENTCERT);
    PYMODULE_ADDINTCONSTANT(LRO_PROXY_SSLCLIENTKEY);
    PYMODULE_ADDINTCONSTANT(LRO_PROXY_SSLCACERT);
    ...
    PYMODULE_ADDINTCONSTANT(LRO_HTTPVERSION);
    PYMODULE_ADDINTCONSTANT(LRO_SENTINEL);

    // HTTP version types
    PYMODULE_ADDINTCONSTANT(LR_HTTPVERSION_DEFAULT);
    PYMODULE_ADDINTCONSTANT(LR_HTTPVERSION_1_1);
    PYMODULE_ADDINTCONSTANT(LR_HTTPVERSION_2TLS);
    PYMODULE_ADDINTCONSTANT(LR_HTTPVERSION_2);
    ...
    PYMODULE_ADDINTCONSTANT(LRI_SSLVERIFYSTATUS);
    ...
    PYMODULE_ADDINTCONSTANT(LRI_PROXY_SSLVERIFYPEER);
    PYMODULE_ADDINTCONSTANT(LRI_PROXY_SSLVERIFYHOST);
    PYMODULE_ADDINTCONSTANT(LRI_PROXY_SSLCLIENTCERT);
    PYMODULE_ADDINTCONSTANT(LRI_PROXY_SSLCLIENTKEY);
    PYMODULE_ADDINTCONSTANT(LRI_PROXY_SSLCACERT);
    ...
    PYMODULE_ADDINTCONSTANT(LRI_HTTPVERSION);
